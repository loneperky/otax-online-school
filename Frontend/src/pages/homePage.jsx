     ...
     <div className="overall-section1">
      <div className="section1">
        <div className="hero1">
          ...
          <p>Connecting <Link>Top Developers</Link> with Global Projects,</p>
          <p>fueling innovations and success for all.</p>
          <div className="btn">
            <button className="btn1">Developer Incubator</button>
      ...
      <div className="section2">
        <div className="mini">
          <div className="sub-section3 sec3">
            <h1>Empowering Global Tech  Talent <br /> for  Inovation</h1>
            ...
            <div className="bt">
            <button className="btn2">Become a Developer</button>
            <button className="btn4">Already a Developer</button>
            </div>
